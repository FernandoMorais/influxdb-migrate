...
var (
	...
	betweenwrites  = flag.Duration("betweenwrites", 100*time.Millisecond, "Interval to wait between writes")
	pointsperwrite = flag.Int("pointsperwrite", 5000, "Points per write")
